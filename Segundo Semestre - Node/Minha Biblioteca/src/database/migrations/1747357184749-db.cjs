module.exports = class Db1747357184749 {
    name = 'Db1747357184749'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`autorLivro\` (\`idAutor\` int NOT NULL, \`idLivro\` int NOT NULL, \`createdAt\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, \`deletedAt\` datetime NULL, \`autorId\` int NOT NULL, \`livroId\` int NOT NULL, PRIMARY KEY (\`idAutor\`, \`idLivro\`)) ENGINE=InnoDB`);
